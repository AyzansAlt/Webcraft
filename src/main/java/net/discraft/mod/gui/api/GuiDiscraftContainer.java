...
public class GuiDiscraftContainer {
    ...
    public int height;
    public Minecraft mc;
    public GuiDiscraftScreen parentGUI;
    protected boolean hovered = false;

    public GuiDiscraftContainer(int givenID, int givenPosX, int givenPosY, int givenWidth, int givenHeight, GuiDiscraftScreen givenParentGUI) {
