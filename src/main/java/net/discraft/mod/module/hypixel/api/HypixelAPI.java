package net.discraft.mod.module.hypixel.api;

import com.google.common.base.Preconditions;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import net.discraft.mod.module.hypixel.api.adapters.*;
import net.discraft.mod.module.hypixel.api.exceptions.APIThrottleException;
import net.discraft.mod.module.hypixel.api.exceptions.HypixelAPIException;
import net.discraft.mod.module.hypixel.api.reply.AbstractReply;
import net.discraft.mod.module.hypixel.api.reply.GuildReply;
import net.discraft.mod.module.hypixel.api.request.Request;
import net.discraft.mod.module.hypixel.api.util.Callback;
import net.discraft.mod.module.hypixel.api.util.GameType;
